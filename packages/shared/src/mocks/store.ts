...
export class MockDataStore {
  ...
  public seed() {
    ...
    this.healingSuggestions = generateMockHealingSuggestions(500, this.tests, this.projects, this.users);
  ...
  public getHealingSuggestionById(id: string): MockHealingSuggestion | undefined {
    return this.healingSuggestions.find(h => h.id === id);
  }
  
  public getHealingSuggestionsByProject(projectId: string): MockHealingSuggestion[] {
