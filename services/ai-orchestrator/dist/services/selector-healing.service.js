...
exports.SelectorHealingService = void 0;
class SelectorHealingService {
    ...
    async healSelector(tenantId, request) {
    ...
    async batchHealSelectors(tenantId, requests) {
    ...
    async generateAISuggestions(request, analysis) {
...
Focus on practical, robust selectors that are likely to work.`;
    ...
    applyRuleBasedStrategies(brokenSelector) {
        const suggestions = [];
    ...
    identifyLikelyIssues(selector, context) {
        const issues = [];
    ...
    async logHealingAttempt(tenantId, request, suggestions, analysisTime) {
        try {
...
exports.SelectorHealingService = SelectorHealingService;
//# sourceMappingURL=selector-healing.service.js.map