...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/frontend/node_modules/axios/lib/axios.js [app-ssr] (ecmascript)");
;
class APIClient {
    client;
    token = null;
    ...
    constructor(baseURL){
        ...
        this.client = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].create({
            baseURL: apiUrl,
            timeout: 30000,
            headers: {
    ...
    async refreshToken() {
        ...
        this.refreshPromise = (async ()=>{
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${this.client.defaults.baseURL}/api/v1/auth/refresh`, {}, {
                    headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc560426._.js.map