...
if (MOCK_MODE) {
  console.log(
    "🎭 Integration Service running in MOCK MODE - using mock third-party data"
  );
}
  ...
  private async registerRoutes() {
    ...
    fastify.get("/api/v1/github/repos", async (request, reply) => {
      if (MOCK_MODE && mockAdapters) {
        return {
          success: true,
          data: mockAdapters.github.getRepos(),
          source: "mock",
        };
      }
      return reply
        ...
        .send({
          success: false,
          error: "Live GitHub integration not implemented",
        });
    });
    ...
    fastify.get(
      ...
      async (request, reply) => {
        ...
        if (MOCK_MODE && mockAdapters) {
          return {
            success: true,
            data: mockAdapters.github.getPullRequests(owner, repo),
            source: "mock",
          };
        }
        return reply
    ...
    fastify.get(
      ...
      async (request, reply) => {
        ...
        if (MOCK_MODE && mockAdapters) {
          return {
            success: true,
            data: mockAdapters.github.getCommits(owner, repo),
            source: "mock",
          };
        }
        return reply
    ...
    fastify.get("/api/v1/jira/issues", async (request, reply) => {
      if (MOCK_MODE && mockAdapters) {
        return {
          success: true,
          data: mockAdapters.jira.getIssues(),
          source: "mock",
        };
      }
      return reply
        ...
        .send({
          success: false,
          error: "Live Jira integration not implemented",
        });
    });
    ...
    fastify.get("/api/v1/jira/issues/:key", async (request, reply) => {
      ...
      if (MOCK_MODE && mockAdapters) {
        ...
        if (!issue) {
          return reply
            .code(404)
            .send({ success: false, error: "Issue not found" });
        }
    ...
    fastify.get("/api/v1/slack/channels", async (request, reply) => {
      if (MOCK_MODE && mockAdapters) {
        return {
          success: true,
          data: mockAdapters.slack.getChannels(),
          source: "mock",
        };
      }
      return reply
        ...
        .send({
          success: false,
          error: "Live Slack integration not implemented",
        });
    });
    ...
    fastify.get(
      ...
      async (request, reply) => {
        ...
        if (MOCK_MODE && mockAdapters) {
          return {
            success: true,
            data: mockAdapters.slack.getMessages(channelId),
            source: "mock",
          };
        }
        return reply
    ...
    fastify.get("/api/v1/sentry/errors", async (request, reply) => {
      if (MOCK_MODE && mockAdapters) {
        return {
          success: true,
          data: mockAdapters.sentry.getErrors(),
          source: "mock",
        };
      }
      return reply
        ...
        .send({
          success: false,
          error: "Live Sentry integration not implemented",
        });
    });
    ...
    fastify.get("/api/v1/datadog/metrics", async (request, reply) => {
      ...
      return reply
        ...
        .send({
          success: false,
          error: "Live Datadog integration not implemented",
        });
    });
    ...
    fastify.get("/api/v1/jenkins/builds", async (request, reply) => {
      if (MOCK_MODE && mockAdapters) {
        return {
          success: true,
          data: mockAdapters.jenkins.getBuilds(),
          source: "mock",
        };
      }
      return reply
        ...
        .send({
          success: false,
          error: "Live Jenkins integration not implemented",
        });
    });

    // Jenkins Integration - Get specific build
    fastify.get(
      "/api/v1/jenkins/builds/:buildNumber",
      async (request, reply) => {
        ...
        if (MOCK_MODE && mockAdapters) {
          ...
          if (!build) {
            return reply
              .code(404)
              .send({ success: false, error: "Build not found" });
          }
    ...
    fastify.post("/api/v1/ollama/generate", async (request, reply) => {
      ...
      return reply
        ...
        .send({
          success: false,
          error: "Live Ollama integration not implemented",
        });
    });
    ...
    fastify.get("/api/v1/newrelic/alerts", async (request, reply) => {
      if (MOCK_MODE) {
        ...
        const alerts = Array.from({ length: 20 }, (_, i) => ({
          ...
          application: ["web-app", "api-server", "worker", "database"][
            Math.floor(Math.random() * 4)
          ],
        }));
      ...
      return reply
        ...
        .send({
          success: false,
          error: "Live New Relic integration not implemented",
        });
    });
    ...
    fastify.get("/api/v1/notion/documents", async (request, reply) => {
      if (MOCK_MODE) {
        ...
        const documents = Array.from({ length: 50 }, (_, i) => ({
          ...
          type: ["requirements", "design", "user-story", "technical-spec"][
            Math.floor(Math.random() * 4)
          ],
          author: faker.person.fullName(),
          lastEdited: faker.date.recent({ days: 30 }).toISOString(),
          tags: faker.helpers.arrayElements(
            ["frontend", "backend", "testing", "design", "product"],
            { min: 1, max: 3 }
          ),
      ...
      return reply
        ...
        .send({
          success: false,
          error: "Live Notion integration not implemented",
        });
    });
    ...
    fastify.get("/api/v1/logs/production", async (request, reply) => {
      ...
      return reply
        ...
        .send({
          success: false,
          error: "Live logging integration not implemented",
        });
    });
    ...
    fastify.get("/api/v1/gitlab/projects", async (request, reply) => {
      ...
      return reply
        ...
        .send({
          success: false,
          error: "Live GitLab integration not implemented",
        });
    });
    ...
    fastify.get("/api/v1/circleci/pipelines", async (request, reply) => {
      if (MOCK_MODE) {
        ...
        const pipelines = Array.from({ length: 20 }, (_, i) => ({
          ...
          number: i + 1,
          state: ["success", "failed", "running", "canceled"][
            Math.floor(Math.random() * 4)
          ],
          ...
          vcs: {
            branch: ["main", "develop", "feature/new-ui"][
              Math.floor(Math.random() * 3)
            ],
            commit: {
      ...
      return reply
        ...
        .send({
          success: false,
          error: "Live CircleCI integration not implemented",
        });
    });
    ...
    fastify.get(
      ...
      async (request, reply) => {
        ...
        const integrations =
          await this.integrationsService.getTenantIntegrations(
            tenantId,
            type as any
          );
    ...
    fastify.get(
      ...
      async (request, reply) => {
        ...
        const integration =
          await this.integrationsService.getIntegration(integrationId);

        if (!integration) {
          return reply
            .code(404)
            .send({ success: false, error: "Integration not found" });
        }
    ...
    fastify.get(
      "/api/v1/integrations/:integrationId/github/repos",
      async (request, reply) => {
        try {
          const { integrationId } = request.params as { integrationId: string };
          const repos =
            await this.integrationsService.getGitHubRepositories(integrationId);
    ...
    fastify.post(
      "/api/v1/integrations/:integrationId/github/webhooks",
      async (request, reply) => {
        try {
          const { integrationId } = request.params as { integrationId: string };
          const body = request.body as {
    ...
    fastify.post("/api/v1/jira/tickets", async (request, reply) => {
      try {
        ...
        if (integrations.length === 0) {
          return reply
            .code(400)
            .send({ success: false, error: "No Jira integration configured" });
        }
    ...
    fastify.post(
      "/api/v1/integrations/:integrationId/slack/message",
      async (request, reply) => {
        try {
          const { integrationId } = request.params as { integrationId: string };
          const body = request.body as {
    ...
    fastify.post("/api/v1/notifications", async (request, reply) => {
      try {
        ...
        await this.integrationsService.sendNotification(
          body.tenantId,
          body.type,
          body.data
        );
    ...
    fastify.post(
      ...
      async (request, reply) => {
        try {
          ...
          return reply
            .code(201)
            .send({ success: true, data: { eventId: event.id } });
        } catch (error: any) {
          return reply.code(400).send({ success: false, error: error.message });
        }
      }
    ...
    fastify.post(
      "/api/v1/webhooks/gitlab/:integrationId",
      async (request, reply) => {
        try {
          const { integrationId } = request.params as { integrationId: string };
