# 📚 Shifty Documentation Hub

This directory contains all project documentation organized for developers, testers, and stakeholders.
...
- Update the main README when adding new docs

## 🤝 Contributing to Documentation

1. Follow the existing structure and naming conventions
2. Use Markdown format with proper headers and formatting
